...
public class StartupKinoticketverkauf
{
    ...
    private static Kino erzeugeKinoMitBeispieldaten()
    {
        ...
        final Vorstellung[] vorstellungen = {
                // Heute
                new Vorstellung(saele[0], filme[2], nachmittag, abend, d1, Geldbetrag.valueOf(500)),
                new Vorstellung(saele[0], filme[0], abend, spaet, d1, Geldbetrag.valueOf(700)),
                new Vorstellung(saele[0], filme[0], spaet, nacht, d1, Geldbetrag.valueOf(700)),

                new Vorstellung(saele[1], filme[3], nachmittag, abend, d1, Geldbetrag.valueOf(900)),
                new Vorstellung(saele[1], filme[1], spaet, nacht, d1, Geldbetrag.valueOf(800)),

                new Vorstellung(saele[2], filme[3], abend, spaet, d1, Geldbetrag.valueOf(1000)),
                new Vorstellung(saele[2], filme[4], spaet, nacht, d1, Geldbetrag.valueOf(900)),

                // Morgen
                new Vorstellung(saele[0], filme[0], abend, spaet, d2, Geldbetrag.valueOf(500)),
                new Vorstellung(saele[0], filme[0], spaet, nacht, d2, Geldbetrag.valueOf(700)),

                new Vorstellung(saele[1], filme[2], nachmittag, abend, d2, Geldbetrag.valueOf(900)),
                new Vorstellung(saele[1], filme[4], abend, nacht, d2, Geldbetrag.valueOf(800)),

                new Vorstellung(saele[2], filme[3], nachmittag, abend, d2, Geldbetrag.valueOf(1000)),
                new Vorstellung(saele[2], filme[1], spaet, nacht, d2, Geldbetrag.valueOf(900)),

                // Übermorgen
                new Vorstellung(saele[0], filme[1], abend, spaet, d3, Geldbetrag.valueOf(500)),
                new Vorstellung(saele[0], filme[1], spaet, nacht, d3, Geldbetrag.valueOf(700)),

                new Vorstellung(saele[1], filme[2], nachmittag, abend, d3, Geldbetrag.valueOf(900)),
                new Vorstellung(saele[1], filme[0], abend, nacht, d3, Geldbetrag.valueOf(800)),

                new Vorstellung(saele[2], filme[3], abend, spaet, d3, Geldbetrag.valueOf(1000)),
                new Vorstellung(saele[2], filme[4], spaet, nacht, d3, Geldbetrag.valueOf(900))};
